      ...
      >
        <AccordionSummary
          ...
          sx={{
            ...
            "& .MuiSvgIcon-root": {
              // Target the icon for black color
              color: "black",
            },
          }}
        >
...
export default function BasicAccordion() {
  ...
  return (
    ...
    >
      ...
      <div className={styles.title} id="שאלות נפוצות">
        שאלות נפוצות
      </div>
      <DropdownAccordion
        title="האם סשן אחד עוזר או שחייב תהליך ממושך?"
        content="סשן אחד ללא ספק עוזר ומשחרר המון, אין שום חובה לתהליך.
