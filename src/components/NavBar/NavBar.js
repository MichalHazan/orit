      ...
      <nav className={scrolled ? styles.floatingNav :styles.navbar}>
       ...
       {width<850 && <div className={styles.hamburger} onClick={toggleMenu}>
         ...
         {width>=850 && <div className={styles.row}>
          ...
          <ScrollLink to="ביקורות" smooth={true} duration={1000} offset={-100}><div className={styles.navLink}>ביקורות</div></ScrollLink>
        ...
        <div className={`${styles.navLinks} ${isOpen ? styles.openLinks : ''}`}>
          ...
          <ul>
            ...
            <li><ScrollLink  onClick={closeMenu} to="ביקורות" smooth={true} duration={1000} offset={-100}><div className={styles.navLink}>ביקורות</div></ScrollLink></li>
            ...
            <div className={styles.logo}>
            <img className={styles.navImage} src={logo} alt="לוגו"/>
          </div>
          </ul>
        </div>
      </nav>
